          ...
          <div class="card">
            <div class="card-header">
              {{-- <h3 class="card-title">Manage Patients</h3> --}}
               <button class="btn btn-primary pull-right" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus"></i> Add Gender</button>
            </div>
            <div class="card-body">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="add-gender">
      {{ csrf_field() }}


      <label>Gender Name</label>                       
      <input type="text" class="form-control input-lg" placeholder="" name="gender" required="" autofocus>
